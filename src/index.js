    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                // eslint-disable-next-line no-console
                console.error('[health] Unexpected error during health check', err_1);
                return [2 /*return*/, res.status(200).json({
                        status: 'ok',
                        supabase: 'error',
