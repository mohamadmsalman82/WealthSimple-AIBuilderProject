        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    payload = {
                        actor_id: (_a = params.actor_id) !== null && _a !== void 0 ? _a : null,
                        actor_type: params.actor_type,
                        action: params.action,
                        record_type: params.record_type,
                        record_id: params.record_id,
                        client_id: (_b = params.client_id) !== null && _b !== void 0 ? _b : null,
                        metadata: params.metadata,
                    };
                    return [4 /*yield*/, supabase_1.supabase.from('audit_log').insert(payload)];
                case 1:
                    error = (_c.sent()).error;
                    if (error) {
                ...
                case 2:
                    ...
                    console.error('[audit_log] Unexpected error', {
                        error: err_1 instanceof Error
                            ? { message: err_1.message, stack: err_1.stack }
                            : err_1,
                        params: params,
                    });
                    return [3 /*break*/, 3];
