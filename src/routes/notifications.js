...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientId, _a, data, error, err_1;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, supabase_1.supabase
                        .from('notifications')
                        .select('id, brief_id, client_id, headline, delivered_at, opened_at, status')
            ...
            case 2:
                ...
                return [2 /*return*/, res.status(200).json({
                        notifications: (data !== null && data !== void 0 ? data : []).map(function (row) { return ({
